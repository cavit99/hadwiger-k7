...
| Four-connected graphs excluding `K6-2K2` are four-colourable, except K5 | [Proof](four_connected_five_chromatic_minor.md) · [GREEN audit](four_connected_five_chromatic_minor_audit.md) | No order bound or degree assumption. Also closes the universal-vertex case of the five-connected six-chromatic Q target; the general attachment construction remains open. Novelty is unassessed. |
