# Frozen work plan before the concentrated checkpoint

**Status:** historical snapshot, not current status. The authoritative
[research ledger](../RESEARCH_LEDGER.md) replaces this accumulated plan.

Source: the complete “Current work plan” section of `RESEARCH_LEDGER.md`
at Git `67f528a`. Its original section SHA-256 is
`46a3d0cfe60c9dc8ec23890928483f091eec1398428262e914360a1418c65809`. Only relative links and final separator whitespace were
adjusted below. The designated technical frontiers retain the live details.
