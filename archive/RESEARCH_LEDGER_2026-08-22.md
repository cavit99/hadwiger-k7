...
> **Archived snapshot:** frozen root-ledger state at commit `6c05f1b` (22
> August 2026). It is not a current status authority; consult the
> [authoritative ledger](../RESEARCH_LEDGER.md). Relative links were adjusted
> for this archive location; historical status wording is otherwise preserved.
