<!-- Frozen ledger snapshot from bba234d before documentation cleanup. All status wording below is historical; current authority is ../RESEARCH_LEDGER.md. Relative links are adjusted for this archive location. -->
