...
- [complete two-root packet transfer closes the `k=2` rooted-`K_4` portal
  return; only the three- and four-root exchange orientations remain](hc7_k7minus_sparse_sixcut_rooted_k4_two_root_transfer_completion.md)
